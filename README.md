# Olá, eu sou o Fábio de Melo Fernandes! 👋

Desenvolvedor Júnior focado em construir soluções eficientes e automações que facilitam o dia a dia. Atualmente, dedico meu tempo ao ecossistema JavaScript e Python, com experiência em aplicações web e mobile.
